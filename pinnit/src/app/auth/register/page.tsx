      ...
      <div className="w-full max-w-sm space-y-6">
        ...
        <div className="relative">
          ...
          <div className="relative flex justify-center text-sm">
            <span className="bg-dark px-2 text-gold-dim">or</span>
          </div>
        </div>
        ...
        <div className="space-y-3">
          <button
            ...
            className="w-full py-2 px-4 bg-white hover:bg-neutral-100 text-neutral-900 rounded-lg font-medium transition-colors flex items-center justify-center gap-2"
          >
          ...
          <button
            ...
            className="w-full py-2 px-4 bg-raised hover:bg-surface text-gold rounded-lg font-medium transition-colors flex items-center justify-center gap-2"
          >
